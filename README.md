...
<p align="center">
  <a href="https://github.com/abu/keylingo/releases/latest"><img src="https://img.shields.io/github/v/release/abu/keylingo?style=flat-square&color=4f46e5&label=release" alt="Latest Release"></a>
...
<p align="center">
  <a href="https://github.com/abu/keylingo/releases/latest"><strong>Download</strong></a>
  &nbsp;·&nbsp;
  <a href="#中文">中文</a>
</p>
...
1. **[Download the latest release](https://github.com/abu/keylingo/releases/latest)** (DMG for macOS, MSI / NSIS for Windows).
...
See [GitHub Releases](https://github.com/abu/keylingo/releases) for the full history. Auto-update checks for new versions on launch and points you here.
...
<p align="center">
  <a href="https://github.com/abu/keylingo/releases/latest"><strong>下载</strong></a>
  &nbsp;·&nbsp;
...
1. **[下载最新版](https://github.com/abu/keylingo/releases/latest)**（macOS 选 DMG，Windows 选 MSI 或 NSIS）
...
完整历史见 [GitHub Releases](https://github.com/abu/keylingo/releases)。应用启动时会自动检查更新，发现新版会指向这里。
