...
use crate::chat::model::{
    generate_request_from_openai_messages, stream_with_chat_provider, GenerateOptions,
    GenerateOutput, GenerateRequest, GenerateRequestContext, ModelError, PendingToolCall,
