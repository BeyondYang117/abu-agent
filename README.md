...
[下载最新版](https://github.com/abu/kivio/releases/latest) — macOS `.dmg`（Apple Silicon）· Windows `-setup.exe` 或解压即用的 `-portable.zip`。
...
完整记录：[Releases](https://github.com/abu/kivio/releases)
...
[Latest release](https://github.com/abu/kivio/releases/latest) — macOS `.dmg` (Apple Silicon) · Windows `-setup.exe` or unzip-and-run `-portable.zip`.
...
[Releases](https://github.com/abu/kivio/releases)
