...
- **macOS 图标适配系统外观** —— 感谢 @abu（[#22](https://github.com/abu/kivio/pull/22)）。
...
- **macOS icon follows the system appearance** — thanks to @abu ([#22](https://github.com/abu/kivio/pull/22)).
