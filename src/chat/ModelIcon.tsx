...
/** abu-api 没有独立的第三方图标，使用项目自己的品牌图标。 */
function AbuApiMark({ size = 16, style }: { size?: number; style?: CSSProperties }) {
  return <img src="/logo-mark.png" alt="" width={size} height={size} style={{ flexShrink: 0, ...style }} />
}
...
const PROVIDER_ICON_MAP: Array<[RegExp, string]> = [
  ...
  [/api\.abuai\.chat|abu-api|abu api/, 'AbuApi'],
  [/opencode/, 'OpenCode'],
