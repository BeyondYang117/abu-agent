...
- **Windows** — `Kivio.Desktop_2.8.9_x64-setup.exe`（NSIS 安装包 / installer）
- **macOS** — `Kivio.Desktop_2.8.9_aarch64.dmg`（Apple Silicon，未签名 / unsigned）
...
完整变更 / Full changelog: https://github.com/abu/kivio/compare/v2.8.8...v2.8.9
