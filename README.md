...
**中文** · [English](README.en.md) · [更新日志](https://github.com/abu/kivio/releases)

[下载](https://github.com/abu/kivio/releases/latest) · [功能](#功能) · [文档](#文档) · QQ 群 **1104450740**
...
> 想出现在这里？欢迎通过 [GitHub Issues](https://github.com/abu/kivio/issues) 或 QQ 群 **1104450740** 联系。
...
<td>
感谢 <a href="https://api.abuai.chat">abu-api</a> 赞助本项目。<a href="https://api.abuai.chat">abu-api</a> 提供 GPT / Claude 等多款模型的官方稳定极速 API 中转服务，支持企业级定制、报销开票、7×16h 专属技术支持，更有独家适配的 WebSocket 连接方式，畅享极速首字速度。Codex 补贴倍率低至 0.08。<a href="https://api.abuai.chat">点此注册</a>。<br><br>
在 Kivio 中：设置 → 供应商 → <strong>添加驱动</strong>，选带爱心标记的 <strong>abu-api</strong>，会预填 <code>https://api.abuai.chat/</code>。
</td>
</tr>
</table>
...
完整记录见 [Releases](https://github.com/abu/kivio/releases) · 当前版本说明：[v2.9.4](docs/releases/v2.9.4.md)
...
从 [Releases](https://github.com/abu/kivio/releases/latest) 下载：
...
欢迎 [Issues](https://github.com/abu/kivio/issues) 与 PR。提交前请确保：
...
[![Star History Chart](https://api.star-history.com/svg?repos=abu/kivio&type=Date)](https://www.star-history.com/#abu/kivio&Date)
