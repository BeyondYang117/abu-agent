# ABU Agent Desktop v2.8.8

桌面 AI 助手 · macOS (Apple Silicon) + Windows。Desktop AI assistant for macOS (Apple Silicon) and Windows.

## 下载 / Downloads

- **Windows** — `ABU Agent.Desktop_2.8.8_x64-setup.exe`（NSIS 安装包 / installer）
- **macOS** — `ABU Agent.Desktop_2.8.8_aarch64.dmg`（Apple Silicon，未签名 / unsigned）
...
完整变更 / Full changelog: https://github.com/abu/abu-agent-desktop/compare/v2.8.7...v2.8.8
